	...
	try {
		...
		if ($result == null) {
			...
			if ($result) {
				...
				$stmt = $pdo->prepare("Select c.city_name,a.city,a.street_name,a.postal_code,a.address_id from address a inner join city c on a.city = c.city_id where city = :city");
				...
				$sql = $pdo->prepare("INSERT INTO `city` (`city_name`) VALUES (?);");
